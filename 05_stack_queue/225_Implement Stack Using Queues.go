...
n is the current element count. Push takes O(n) time to rotate older elements;
Pop, Top, and Empty take O(1). Storage is O(n). Go append growth costs
are accounted for using amortized analysis.
*/
