...
n = len(s). Worst-case time O(n), examining each character once;
odd lengths return in O(1). Auxiliary space O(n) stores a linear number
of expected closing brackets in the worst case.
*/
